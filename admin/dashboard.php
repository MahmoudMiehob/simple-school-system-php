  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
        ...
        $sql3 = "SELECT COUNT(*) as total_courses FROM courses";
        $result3 = $conn->query($sql3);
        $total_courses = $result3->fetch_assoc()['total_courses'];

        $sql4 = "SELECT COUNT(*) as total_subjects FROM subjects";
        $result4 = $conn->query($sql4);
        $total_subjects = $result4->fetch_assoc()['total_subjects'];
        ?>
        <div class="row my-4">
          <div class="col-12 col-md-6 col-lg-3 mb-4 mb-lg-0">
            <div class="card">
              <h5 class="card-header bg-info">teachers</h5>
              <div class="card-body">
                <h5 class="card-title">Total teachers : <?= $total_teachers ?></h5>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-6 mb-4 mb-lg-0 col-lg-3">
            <div class="card">
              <h5 class="card-header bg-success">students</h5>
              <div class="card-body">
          ...
          <div class="col-12 col-md-6 mb-4 mb-lg-0 col-lg-3">
            <div class="card">
              <h5 class="card-header bg-secondary">courses</h5>
              <div class="card-body">
                <h5 class="card-title">Total courses : <?= $total_courses ?></h5>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-6 mb-4 mb-lg-0 col-lg-3">
            <div class="card">
              <h5 class="card-header bg-warning">subjects</h5>
              <div class="card-body">
                <h5 class="card-title">Total subjects : <?= $total_subjects ?></h5>
              </div>
            </div>
          </div>
        </div>
        <p class="text-center">last update : <?php echo date("j, n, Y"); ?></p>
