  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
        ...
        $sql2 = "SELECT COUNT(*) as total_students FROM students_courses where teacher_id = $teacher_id";
        $result2 = $conn->query($sql2);
        $total_students = $result2->fetch_assoc()['total_students'];

        $sql3 = "SELECT COUNT(*) as total_courses FROM courses where teacher_id = $teacher_id";
